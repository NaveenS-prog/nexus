...
export function TodayFocusTimeline({ items, onToggleStatus, onSelectItem }: TodayFocusTimelineProps) {
  // Sort items chronologically: calendar/scheduled items first by startAt, then by dueAt
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3.5 min-w-0 pr-4">
                  {/* Time Badge */}
                  <span className="font-mono text-xs font-semibold text-zinc-400 w-12 flex-shrink-0">
                    {timeLabel}
                  </span>
                  ...
                  <button
                    ...
                    className={`flex-shrink-0 transition-transform active:scale-90 ${
                      isCalendarEvent ? "cursor-default text-zinc-600" : "cursor-pointer"
                    }`}
                  >
                    {isCompleted ? (
